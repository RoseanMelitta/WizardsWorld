...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switchTheme.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    // Verifică starea comutatorului și setează tema corespunzătoare
                ...
                // Redirecționează utilizatorul către ecranul principal pentru a aplica tema
        ...
        // Inițializarea și configurarea butonului de salvare a profilului
        ...
        // Inițializarea instanței Firebase Authentication
    ...
    // Metoda pentru salvarea profilului utilizatorului
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Log.i("email updated", "email updated");
                            } else {
                                // Email update failed
                                Log.i("email update failed", "email update failed");
